...
string = r'D:\Lehigh University Classes\Research\Code\Code for Multiobjective Paper\New Code for Revision 2023\Plots\Figure 4\fig_solution_GKV1_nonsep_LS.pdf'
...
# # Uncomment the next line to save the plot
string = r'D:\Lehigh University Classes\Research\Code\Code for Multiobjective Paper\New Code for Revision 2023\Plots\Figure 4\fig_solution_pareto_fronts_GKV1_nonsep.pdf'
fig.savefig(string, dpi=100, format='pdf')
