...
class SyntheticBilevelMultiobjProblem:
    ...
    def __init__(self, x_dim, y_dim, num_obj, std_dev, seed=42):
        ...
        # self.ll_prob = GKV1(self.x_dim, self.y_dim, self.std_dev)
...
class Quadratic1:
    ...
    def __init__(self, x_dim, y_dim, std_dev):
        ...
        self.a = np.ones((self.x_dim,1))#*3
        self.b = np.ones((self.y_dim,1))    
