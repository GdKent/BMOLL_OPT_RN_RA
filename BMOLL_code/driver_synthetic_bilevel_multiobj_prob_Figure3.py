...
import functions_bilevel_multiobj_Figure3 as func
import bilevel_multiobj_solver_Figure3 as bls
import time
import pickle 
...
string = r'D:\Lehigh University Classes\Research\Code\Code for Multiobjective Paper\New Code for Revision 2023\Plots\Figure 3\fig_solution_GKV1.pdf'
...
# # Uncomment the next line to save the plot
string = r'D:\Lehigh University Classes\Research\Code\Code for Multiobjective Paper\New Code for Revision 2023\Plots\Figure 3\fig_solution_pareto_fronts_GKV1.pdf'
fig.savefig(string, dpi=100, format='pdf')
...
# # Uncomment the next line to save the plot
string = r'D:\Lehigh University Classes\Research\Code\Code for Multiobjective Paper\New Code for Revision 2023\Plots\Figure 3\fig_solution_2D_GKV1.pdf'
fig.savefig(string, dpi=100, format='pdf')
