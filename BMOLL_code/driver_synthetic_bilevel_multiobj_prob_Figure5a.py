...
import bilevel_multiobj_solver as bls
import time
import pickle 
...
# import sys
# sys.path.append(r'D:\Lehigh University Classes\Research\Code\Stochastic Bilevel\Synthetic Problem\Code Used in Paper\BSG1')
...
# # BSG-OPT-1 (inc. acc.)
# exp_param_dict[5] = {'algo': 'bsg', 'risk_level': 0, 'algo_full_name': 'bsgopt1_incacc_FS_std2', \
...
# # BSG-RN-1 (inc. acc.)
# exp_param_dict[5] = {'algo': 'bsg', 'risk_level': 1, 'algo_full_name': 'bsgrn1_incacc_FS_std2', 'num_pareto_points_risk_neutral': 500, 'minibatch_size_rn': 20,\
...
# exp_param_dict[5] = {'algo': 'bsg', 'risk_level': 2, 'algo_full_name': 'bsgra1_incacc_FS_std05', \
#                      'ul_stepsize_scheme': 1, 'ul_lr': 1e-1, 'll_lr': 1e-3, 'use_stopping_iter': use_stopping_iter, \
#                      'max_iter': max_iter, 'stopping_time': stopping_time, 'inc_acc': True, 'hess': False, 'normalize': False, 'iprint': iprint, \
#                      'run_exp': False, 'save_output': True}                                                                                                                                                 
...
# BSG-OPT-H (inc. acc.)
# exp_param_dict[5] = {'algo': 'bsg', 'risk_level': 0, 'algo_full_name': 'bsgopth_incacc_FS_std05', \
#                      'ul_stepsize_scheme': 1, 'ul_lr': 1e-1, 'll_lr': 1e-3, 'use_stopping_iter': use_stopping_iter, \
#                      'max_iter': max_iter, 'stopping_time': stopping_time, 'inc_acc': True, 'hess': True, 'normalize': False, 'iprint': iprint, \
#                      'run_exp': False, 'save_output': True}
                    
# BSG-RN-H (inc. acc.)
exp_param_dict[0] = {'algo': 'bsg', 'risk_level': 1, 'algo_full_name': 'bsgrnh_incacc_LS_500_mb500_std0_time1800', 'num_pareto_points_risk_neutral': 500, 'minibatch_size_rn': 500,\
...
# # BSG-RA-H (inc. acc.)
# exp_param_dict[5] = {'algo': 'bsg', 'risk_level': 2, 'algo_full_name': 'bsgrah_incacc_FS_std05', \
#                      'ul_stepsize_scheme': 1, 'ul_lr': 1e-1, 'll_lr': 1e-3, 'use_stopping_iter': use_stopping_iter, \
#                      'max_iter': max_iter, 'stopping_time': stopping_time, 'inc_acc': True, 'hess': True, 'normalize': False, 'iprint': iprint, \
#                      'run_exp': False, 'save_output': True}
...
string = r'D:\Lehigh University Classes\Research\Code\Code for Multiobjective Paper\New Code for Revision 2023\Plots\Figure 5\fig_solution_GKV1_nonsep_LS_RN_ci.pdf'
