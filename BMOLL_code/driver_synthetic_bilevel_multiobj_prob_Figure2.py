...
import functions_bilevel_multiobj_Figure2 as func
import bilevel_multiobj_solver_Figure2 as bls
import time
import pickle 
...
prob = func.SyntheticBilevelMultiobjProblem(x_dim=x_dim_val, y_dim=y_dim_val, num_obj=num_obj_val, std_dev=std_dev_val)
...
plot_legend_list = ['BSG-OPT-H LS','BSG-RN-H LS','BSG-RA-H LS'] 
...
#                      'ul_stepsize_scheme': 0, 'ul_lr': 1e-1, 'll_lr': 1e-3, 'use_stopping_iter': use_stopping_iter, \
...
#                      'ul_stepsize_scheme': 0, 'ul_lr': 1e-0, 'll_lr': 1e-3, 'use_stopping_iter': use_stopping_iter, \
#                      'max_iter': max_iter, 'stopping_time': stopping_time, 'inc_acc': True, 'hess': False, 'normalize': False, 'iprint': iprint, \
#                      'run_exp': True, 'save_output': False}
...
# BSG-RN-H (inc. acc.)
exp_param_dict[1] = {'algo': 'bsg', 'risk_level': 1, 'algo_full_name': 'bsgrnh_incacc_LS_500_mb500_std0_time1800', 'num_pareto_points_risk_neutral': 500, 'minibatch_size_rn': 500,\
                      'ul_stepsize_scheme': 2, 'ul_lr': 1e-0, 'll_lr': 1e-3, 'use_stopping_iter': use_stopping_iter, \
                      'max_iter': max_iter, 'stopping_time': stopping_time, 'inc_acc': True, 'hess': True, 'normalize': False, 'iprint': iprint, \
...
string = r'D:\Lehigh University Classes\Research\Code\Code for Multiobjective Paper\New Code for Revision 2023\Plots\Figure 2\fig_solution_JOS1.pdf'
...
# # Uncomment the next line to save the plot
string = r'D:\Lehigh University Classes\Research\Code\Code for Multiobjective Paper\New Code for Revision 2023\Plots\Figure 2\fig_solution_pareto_fronts_JOS1.pdf'
fig.savefig(string, dpi = 100, format='pdf')
...
plt.text(fl1_value, fl2_value-0.5, "$(x_{OPT},y_{OPT})$", horizontalalignment='left', size='large', color='black', weight='extra bold')
...
# # Uncomment the next line to save the plot
string = r'D:\Lehigh University Classes\Research\Code\Code for Multiobjective Paper\New Code for Revision 2023\Plots\Figure 2\fig_solution_2D_JOS1.pdf'
fig.savefig(string, dpi = 100, format='pdf')
